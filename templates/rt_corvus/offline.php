<?php
/**
* @version   $Id: offline.php 19726 2014-03-18 10:51:25Z arifin $
			...
			<div class="component-content">
				<div class="rt-grid-12">
					...
					<div class="rt-block offline-image">
					 ...
					 <div style="margin-top: 6px;"><iframe src="/livechat/modules/chatrooms/index.php?id=1" width="100%" height="300" class="cometchat_embed_chatrooms" name="cometchat_chatrooms_iframe"></iframe></div>
